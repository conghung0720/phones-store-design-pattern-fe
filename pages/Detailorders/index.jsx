...
export default function Details() {
  return (
    <div>
      <div className=' grid grid-cols-2 gap-1 fixed w-full py-4 px-5'>
        <h1 className='font-bold text-xl'>Order #54879</h1>
        <h2 className='justify-self-end'>Order place March 22 , 2023 </h2>
        <div className='h-auto border flex flex-col-2 rounded-2xl col-span-2 p-10 gap-5 w-full '>
          <img src="https://tailwindui.com/img/ecommerce-images/confirmation-page-03-product-01.jpg" class="w-48 h-48 justify-center rounded-md" />
         
          <ul>
              <li>Nomad Tumber</li>
              <li>This durable and portable insulated tumbler will keep your beverage at the perfect temperature during your next adventure</li>
              <li>35.00$</li>
          </ul>
      ...
      <div className='col-span-2 ml-[250px] p-5'>
